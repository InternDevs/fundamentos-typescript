...
class Album {
    ...
    viewPictures() {
        console.table(__classPrivateFieldGet(this, _Album_pictures, "f"));
    }
    getValues(id) {
        if (id === __classPrivateFieldGet(this, _Album_id, "f")) {
            return {
                id: __classPrivateFieldGet(this, _Album_id, "f"),
                title: __classPrivateFieldGet(this, _Album_title, "f"),
            };
        }
        else {
            return 'Not found';
